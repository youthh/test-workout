...
```bash
cat /Users/emotion/Desktop/iron-academy/vercel.json
```
Make sure it does NOT contain `nodeVersion` — that field breaks Vercel builds. If it's there, remove it before committing.
